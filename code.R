...
# (2) I want to add some additional columns of data -- such as day, month, year -- that provide additional opportunities to aggregate the data.
...
# (4) There are some rides where tripduration shows up as negative, including several hundred rides where Divvy took bikes out of circulation for Quality Control reasons. I have changed this before importing the data into R studio via Microsoft excel.

# In the "member_casual" column, I will be replacing "Subscriber" with "member" and "Customer" with "casual"
# Before 2020, Divvy used different labels for these two types of riders ... I want to make the dataframe consistent
table(all_trips$member_casual)

# I am going to Reassign to the desired values
all_trips <-  all_trips %>% 
...
# I will be adding columns that list the date, month, day, and year of each ride
...
# I shall add a "ride_length" calculation to all_trips (in seconds)
